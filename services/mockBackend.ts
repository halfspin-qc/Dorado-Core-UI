...
export const MOCK_DOCS: DocumentFile[] = [
  { id: '1', name: 'Azure_B4ms_Specs.pdf', size: '1.2 MB', chunks: 142, status: 'indexed', uploadDate: '2023-10-24' },
  { id: '2', name: 'Q3_Financial_Report.docx', size: '450 KB', chunks: 56, status: 'indexed', uploadDate: '2023-10-25' },
  { id: '3', name: 'Project_Titan_Logs.txt', size: '8.4 MB', chunks: 1205, status: 'processing', uploadDate: '2023-10-26' },
];
